const {encoderIdmg, verifierIdmg, getIdmg} = require('./idmg')
...
describe('idmg', ()=>{
  ...
  test('verifier idmg MilleGrille', async () => {
    const idmg = await getIdmg(CERT_PEM)
    console.debug("IDMG extrait : %O", idmg)
    expect(idmg).toBe(IDMG_V2)
  })
