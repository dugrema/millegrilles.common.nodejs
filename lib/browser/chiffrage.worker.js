...
import {
  ...
  chiffrerDocument as _chiffrerDocument, dechiffrerDocument
} from '../chiffrage'
...
async function chiffrerDocument(doc, domaine, certificatChiffragePem, identificateurs_document, opts) {
  const resultat = await _chiffrerDocument(doc, domaine, certificatChiffragePem, identificateurs_document, opts)
