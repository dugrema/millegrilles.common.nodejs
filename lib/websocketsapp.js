  ...
  registerEvents(rabbitMQ, socketResources) {
    ...
    socket.on('subscribe', message => {
      ...
      rabbitMQ.routingKeyManager
        .addRoutingKeysForSocket(socket, message.routingKeys, message.niveauSecurite, channel, reply_q);
    });

    socket.on('unsubscribe', message => {
      // console.debug("Message unsubscribe");
      // console.debug(message);
      debug("Unsubscribe message:\n%O", message)
      rabbitMQ.routingKeyManager
        .removeRoutingKeysForSocket(socket, message.routingKeys, message.niveauSecurite, channel, reply_q);
    });
