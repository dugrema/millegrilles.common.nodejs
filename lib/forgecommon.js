...
function extraireExtensionsMillegrille(certificatForge) {
  ...
  } catch(err) {console.error("Erreur lecture userId du certificat: %O", err)}
  ...
  } catch(err) {console.error("Erreur lecture delegationGlobale du certificat: %O", err)}
  ...
  } catch(err) {console.error("Erreur lecture delegationsDomaines du certificat: %O", err)}
  ...
  } catch(err) {console.error("Erreur lecture delegationsSousDomaines du certificat: %O", err)}
