...
export class MilleGrillesCryptoHelper {
  ...
  async chiffrerDictionnaire(signateurTransaction, certificatMaitredescles, identificateurs_document, contenu) {
    // Params :
    ...
    const uuidTransactionCle = transactionMaitredescles['en-tete']['uuid-transaction']

    const entreeDocument = {
      chiffrement: 'mgs1',
      'uuid-transaction': uuidTransactionCle,
      identificateurs_document,
