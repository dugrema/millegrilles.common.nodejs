...
const {extraireInformationCertificat} = require('./forgecommon')
      ...
      reader.onload = async _ => {
        try {
          ...
          for(let idx in pemCerts) {
            ...
            const {fingerprint, clePubliquePem: clePublique} = extraireInformationCertificat(pem)
            ...
            clesChiffreesParCert[fingerprint] = btoa(String.fromCharCode.apply(null, new Uint8Array(cleSecreteChiffree)))
          }
