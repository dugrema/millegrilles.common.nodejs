...
function _initSocketIo(server, paramsSocketio, opts) {
  ...
  socketIo.on('connection', async (socket) => {
    ...
    try {
      ...
      socket.upgradeProtege = upgradeProtege
      socket.upgradeProprietaire = upgradeProprietaire
...
function upgradeProprietaire(socket) {
  ...
  if(socket.listenersProprietaires) enregistrerListener(socket.listenersProprietaires)
}
